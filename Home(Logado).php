        ...
        <div class="container-fluid"><a class="navbar-brand" href="Home(Logado).php" style="color: rgba(255,255,255,0.9);background-image: url(&quot;assets/img/logo.png&quot;);width: 170px;height: 100px;margin: 5px;"></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon" style="background-color: rgba(255,255,255,0);background-image: url(&quot;assets/img/menu_hamburger.png&quot;);width: 50px;height: 50px;"></span></button>
            <div
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item" role="presentation" style="margin-right: 0px;"><a class="nav-link active" href="Home(Logado).php" style="color: rgba(255,255,255,0.9);font-family: 'Press Start 2P', cursive;font-size: 15px;padding-right: 8px;margin-right: 0px;">Home</a></li>
            ...
            <div class="col" style="padding: 15px;">
                <div class="carousel slide" data-ride="carousel" id="carousel-1" style="margin: 35px;">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active" style="background-image: url(&quot;assets/img/project1.jpg&quot;);"><a href="ProjetosDaComunidade(Logado).php?linguagem=Java"><img class="w-100 d-block" src="assets/img/java.jpg" alt="Slide Image"></a></div>
                        <div class="carousel-item"><a href="ProjetosDaComunidade(Logado).php?linguagem=Python"><img class="w-100 d-block" src="Imagens/python.jpg" alt="Slide Image"></a></div>

                        <div class="carousel-item"><a href="ProjetosDaComunidade(Logado).php?linguagem=Arduino"><img class="w-100 d-block" src="Imagens/arduino.jpg" alt="Slide Image"></a></div>
                        <div class="carousel-item"><a href="ProjetosDaComunidade(Logado).php?linguagem=C"><img class="w-100 d-block" src="Imagens/c2.jpg" alt="Slide Image"></a></div>
                        <div class="carousel-item"><a href="ProjetosDaComunidade(Logado).php?linguagem=JavaScript"><img class="w-100 d-block" src="Imagens/js.jpg" alt="Slide Image"></a></div>
                        <div class="carousel-item"><a href="ProjetosDaComunidade(Logado).php?linguagem=PHP"><img class="w-100 d-block" src="assets/img/php.jpg" alt="Slide Image" style="padding: 0px;"></a></div>
                    </div>
        ...
        <div class="row">
            <div class="col" style="padding: 0px 15px;">
                <div class="card-group" style="margin: 35px;">
                    <a href="PaginaDoProjeto(Logado).php?projeto=12">
                    <div class="card" style="background-color: #2D8CEB;margin-right: 15px;"><img style="background-image: url(&quot;assets/img/project1.jpg&quot;);width: 333px;height: 200px;background-color: #2D8CEB;" src="assets/img/fibonacci.png">
...
Fibonacci</h4>
                    ...
                    <a href="PaginaDoProjeto(Logado).php?projeto=1">
                    ...
                    <a href="PaginaDoProjeto(Logado).php?projeto=19">
