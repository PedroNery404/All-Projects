...
<html>
<head>
    <title>Projetos Da Comunidade(Logado)</title>
...
<body style="background-color: gray;">
        ...
        <div class="container-fluid"><a class="navbar-brand" href="Home(Logado).php" style="color: rgba(255,255,255,0.9);background-image: url(&quot;assets/img/logo.png&quot;);width: 170px;height: 100px;margin: 5px;"></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon" style="background-color: rgba(255,255,255,0);background-image: url(&quot;assets/img/menu_hamburger.png&quot;);width: 50px;height: 50px;"></span></button>
            <div
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item mx-3" role="presentation"><a class="nav-link" href="ProjetosDaComunidade(Logado).php" style="color: rgba(255,255,255,0.9);font-family: 'Press Start 2P', cursive;font-size: 15px;padding-right: 8px;">Projetos</a></li>
    ...
    <?php
        ...
        if ($procura=="linguagem") {
            ...
            $link="ProjetosDaComunidade(Logado).php?linguagem=$linguagem"; 
            ...
            $link="ProjetosDaComunidade(Logado).php?";
        ...
        while($row_usuario = mysqli_fetch_assoc($resultado_usuarios)){
            ...
            echo "<a style='color:white;text-decoration: none;;font-size: 25px;' href='PaginaDoProjeto(Logado).php?projeto=$projeto'>Nome do Projeto: " . $row_usuario['Nome'] . "<br>";
